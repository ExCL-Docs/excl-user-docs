...
![Foxy Proxy Settings](../.gitbook/assets/foxyproxy-settings.png)
...
<img src="../.gitbook/assets/foxyproxy-settings-mac.png" alt="Foxy Proxy Proxy DNS Settings for Mac" data-size="original">
{% endhint %}
